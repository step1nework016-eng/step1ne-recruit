...
| 優先序 | 對象 | 為什麼 |
|---|---|---|
| 🥇 最想要 | 人資**主管**／人資**經理**／招募**主管**／HR Manager／HRBP 主管 | 手上有預算與委外決策權，而且「補不滿」是他的績效壓力——**他有動機回信** |
| 🥈 可以接受 | 人資部門的**公開招募信箱**（官網上寫明的那種） | 至少會被分派到對的人手上 |
| 🥉 最後才用 | 招募**專員**／HR 承辦 | ⚠️ 他的 KPI 就是「自己補到人」，委外等於承認補不到，**他有動機不回** |

**所以：先找主管，找不到才退而求其次。**
找到的是承辦層級時，`contact_level` 要如實標 `staff`，
讓後面寫信的人知道要加一句「如果這部分由其他同仁負責，也麻煩幫我轉一下」。
...
3. **公開的 LinkedIn 個人頁**（搜尋引擎找得到的那種，不要登入）——
   ⚠️ **先搜主管職稱**：「公司名 + 人資經理 / 人資主管 / 招募主管 /
   HR Manager / Head of Talent / 人力資源處長 / 人資協理」，
   搜不到主管才退回搜「人資 / 招募 / HR / Recruiter」。
...
{{
  "results": [
    {{
      ...
      "contact_level": "manager|staff|dept_mailbox|unknown —— manager=主管級（經理/協理/處長/Head/Manager），staff=專員或承辦，dept_mailbox=部門信箱沒有具體人",
